...
public final class PublicApiV2 {
    ...
    public final static class data {
        final static String apiRoot = "https://api.at.govt.nz/v2/";
        ...
        final static String realtime = "public/realtime";
        final static String stopInfo = "gtfs/stops/stopinfo/";
        final static String tripUpdates = "public/realtime/tripUpdates/";
